      ...
      <div class="row">
        <div class="col-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control is-valid" name="example-text-input-valid" placeholder="ex. Inova Reborn">
          </div>

        </div>
        <div class="col-6">
            <br />
        <button type="submit" class="form-label btn btn-primary" name="button">Proses</button>
